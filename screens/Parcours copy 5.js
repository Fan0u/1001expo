...
TaskManager.defineTask("test", ({ data, error }) => {
	...
	if (true) {
		...
		console.log("DEFINE TASK START", data.eventType);
...
const Cordinate = ({ navigation }) => {
	...
	// 			setErrorMsg("Permission to BACKGROUND access location was denied");
	// 			return;
	// 		}
	...
	// useEffect(() => {
	// 	if (Location.GeofencingRegionState.Inside) {
	// 		console.log("useEffect = Inside", Location.GeofencingRegionState.Inside);
	// 	} else if (Location.GeofencingRegionState.Inside == 2) {
	// 		console.log("useEffect = Outiside", Location.GeofencingRegionState.Inside);
	// 	} else {
	// 		console.log("useEffect = undefined");
	// 	}
	// 	return () => {
	// 		console.log("useEffect = Inside ou pas");
	// 	};
	// }, []);
